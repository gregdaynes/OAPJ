<?php
/**
 * @version		$Id: fullbanner.php 302 2010-11-22 20:26:55Z jevolve $
...
foreach($adIds as $index=>$adId) { ?>
	<a href="<?php echo $params->get('ckurl').'?bannerid='.$adId.'&'.$ncode; ?>" target='_blank'>
		<img src="<?php echo $params->get('avwurl').'?bannerid='.$adId.'&'.$ncode; ?>" border='0' alt='<?php echo $alts[$index]; ?>' width="468" height="60" />
	</a>
<?php }